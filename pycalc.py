...
display = Label(window, text="9+9", width=25, relief=GROOVE)
...
button7 = Button(rad1, text=7, width=5)
button7.grid(row=1, column=0)
button8 = Button(rad1, text=8, width=5)
button8.grid(row=1, column=1)
button9 = Button(rad1, text=9, width=5)
button9.grid(row=1, column=2)
buttonaddition = Button(rad1, text="+", width=5)
buttonaddition.grid(row=1, column=3)

button4 = Button(rad2, text=4, width=5)
button4.grid(row=2, column=0)
button5 = Button(rad2, text=5, width=5)
button5.grid(row=2, column=1)
button6 = Button(rad2, text=6, width=5)
button6.grid(row=2, column=2)
buttonsubtraction = Button(rad2, text="-", width=5)
buttonsubtraction.grid(row=2, column=3)

button1 = Button(rad3, text=1, width=5)
button1.grid(row=3, column=0)
button2 = Button(rad3, text=2, width=5)
button2.grid(row=3, column=1)
button3 = Button(rad3, text=3, width=5)
button3.grid(row=3, column=2)
buttonmultiplication = Button(rad3, text="*", width=5)
buttonmultiplication.grid(row=3, column=3)

button0 = Button(rad4, text=0, width=5)
